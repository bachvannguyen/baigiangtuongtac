		...
		<div class="row pdt10">
			...
			<div class="col-md-6">
				...
				if( get_theme_mod( 'business_press_tpbr_left_view', '1' ) != 3 )
				{
					...
					?>
						...
						<?php
						echo wp_kses_post( get_theme_mod( 'business_press_top_bar_left_content', '<p><span class="fa fa-phone"></span> ' . esc_attr__( 'Call:', 'business-press' ) . ' <a href="tel:01677071167">01677071167</a> | <span class="fa fa-at"></span> ' . esc_attr__( 'Email:', 'business-press' ) . ' <a href="mailto:nguyenbachvan95@gmail.">nguyenbachvan95@gmail.com</a></p>' ) );
						?>
						</div>
					<?php
					}
					...
					?>
						...
						<?php
						if( get_theme_mod( 'business_press_tpbr_lft_phne', esc_attr__( '01677071167', 'business-press' ) ) )
						{
						?>
							<span class="fa fa-phone"></span><?php esc_attr_e( ' Call: ', 'business-press' ) ?><a href="tel:<?php echo esc_attr( get_theme_mod( 'business_press_tpbr_lft_phne', esc_attr__( '01677071167', 'business-press' ) ) ); ?>"><?php echo esc_attr( get_theme_mod( 'business_press_tpbr_lft_phne', esc_attr__( '01677071167', 'business-press' ) ) ); ?></a>
						<?php
						}
						?>
						
						<?php
						if( get_theme_mod( 'business_press_tpbr_lft_phne', esc_attr__( '01677071167', 'business-press' ) ) && get_theme_mod( 'business_press_tpbr_lft_email', esc_attr__( 'info@example.com', 'business-press' ) ) )
						{
						...
						{
						?>
							<span class="fa fa-at"></span><?php esc_attr_e( ' Email: ', 'business-press' ) ?><a href="mailto:<?php echo esc_attr( get_theme_mod( 'business_press_tpbr_lft_email', esc_attr__( 'nguyenbachvan95@gmail.com', 'business-press' ) ) ); ?>"><?php echo esc_attr( get_theme_mod( 'business_press_tpbr_lft_email', esc_attr__( 'nguyenbachvan95@gmail.com', 'business-press' ) ) ); ?></a>
						<?php
						}
						?>
			...
			<div class="col-md-6">
				<p class="fr-spsl iconouter">
					...
					{
						if( get_theme_mod( 'business_press_social_profile_link_facebook', 'https://www.facebook.com/baigiangtuongtacchuyennghiep/' ) )
						{
						?>
							<a title="<?php esc_attr_e( 'Facebook', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'business_press_social_profile_link_facebook', 'https://www.facebook.com/baigiangtuongtacchuyennghiep/' ) ); ?>"><span class="fa fa-facebook bgtoph-icon-clr"></span></a>
						<?php
						}
						?>
						...
						{
						?>
							<a title="<?php _e( 'VK', 'business-press' ); ?>" target="_blank" href="<?php echo esc_url( get_theme_mod( 'social_profile_link_vk' ) ); ?>"><span class="fa fa-vk bgtoph-icon-clr"></span></a>
						<?php
						}
						?>
